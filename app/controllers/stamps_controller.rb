class StampsController < ApplicationController
  ...
  private
    ...
    def stamp_params
      params.require(:stamp).permit(:description, :image, :category, :price_range, :neighborhood, :name, :adr_street_number, :adr_route, :adr_city, :adr_postal_code, :adr_state, :adr_country, :phone_number, :id)
    end
end
